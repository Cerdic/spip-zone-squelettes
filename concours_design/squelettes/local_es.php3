...
// Este es un fichero idioma de SPIP para el esqueleto Sarka-SPIP  --  Ceci est un fichier langue de SPIP pour le squelette Sarka-SPIP  

//Las cadenas de car&aacute;cteres est&aacute;n agrupadas seg&uacute;n el fichero que las utiliza m&aacute;s

$GLOBALS[$GLOBALS['idx_lang']] = array(

//footer.html

        'faitavec' => 'Este sitio funciona gracias a',
        'kezakospip' => 'un CMS gratuito bajo licencia GPL',
        'squelette' => 'Esqueleto',
        'licence' => 'bajo licencia',
        'faitpar' => 'realizado por',
...
//recherche.html
        ...
        'recherche_rubrique_resultat' => 'Secciones encontradas',
        'recherche_mots_resultat' => 'Palabras claves encontradas y art&iacute;culos relacionados',
        'recherche_rubriques_resultats' => 'Breves encontradas',
        'recherche_sites_resultats' => 'Sitios Web encontrados',
        'recherche_messages_resultats' => 'Mensajes encontrados en los foros',
        'recherche_articles_resultats' => 'Art&iacute;culos encontrados',
