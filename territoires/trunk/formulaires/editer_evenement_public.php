...
function formulaires_editer_evenement_public_charger_dist($id_evenement='new', $id_article=0, $retour='', $lier_trad = 0, $config_fonc='evenements_edit_config', $row=array(), $hidden=''){
 ...
 */
function formulaires_editer_evenement_public_identifier_dist($id_evenement='new', $id_article=0, $retour='', $lier_trad = 0, $config_fonc='evenements_edit_config', $row=array(), $hidden=''){
...
function formulaires_editer_evenement_public_verifier_dist($id_evenement='new', $id_article=0, $retour='', $lier_trad = 0, $config_fonc='evenements_edit_config', $row=array(), $hidden=''){
...
function formulaires_editer_evenement_public_traiter_dist($id_evenement='new', $id_article=0, $retour='', $lier_trad = 0, $config_fonc='evenements_edit_config', $row=array(), $hidden=''){
	...
	if (!intval($id_evenement)
		...
		evenement_modifier($res['id_evenement'],array('statut'=>'prop'));
	}
