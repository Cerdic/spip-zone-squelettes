...
if ($connect_statut=='0minirezo' AND acces_rubrique($id_rubrique) AND $statut=='publie') {
	//lien TB
	icone_horizontale(_T('trackbacks:icone_envoi'),
		"envoi_trackback.php?id_breve=$id_breve", "trackback-24.png", "");
	icone_horizontale(_T('trackbacks:icone_suivi_cette_breve'),
		"controle_forum.php3?mode=trackbacks&amp;id_breve=$id_breve", "trackback-24.png", "");
}
