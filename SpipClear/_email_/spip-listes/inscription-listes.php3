...
// abo
        ...
        if($i>1){
        // $message .= _T('spiplistes:bloogletter_mail_format', array('nom_site_spip' => $nom_site_spip))." : ".$GLOBALS['suppl_abo']."\n";
	...
	if(ereg("\?",$self)){
		...
		echo  "</div>";   
        echo  "<div class=\"bloogletter-right\"><input type=\"submit\" name=\"Valider\" class=\"spip_bouton\" value=\""._T('bouton_valider')."\">";
