...
<?php dcDayDate('<p class="day-date">%s</p>'); ?>
	<div class="post">
		...
		<br/>Cat&eacute;gorie : <a href="<?php dcPostCatURL(); ?>"><?php dcPostCatTitle(); ?></a>
		</p>
		
		<div class="post-content" <?php dcPostLang(); ?>>
			<?php dcPostAbstract('%s','<p><a href="%s" title="Lire %s">Suite...</a></p>'); ?>
		</div>
		...
		?></a>
		&nbsp; <a href="<?php dcPostURL(); ?>#tb"
		title="trackbacks pour : <?php dcPostTitle(); ?>"><?php
		dcPostNbTrackbacks('aucun trackback','un trackback','%s trackbacks');
		?></a> &nbsp; <a href="#debut"><img src="<?php dcInfo('theme'); ?>/images/champi.png" alt="Haut de page" title="Haut de page"/></a></p>
	</div>
<?php endwhile; ?>
