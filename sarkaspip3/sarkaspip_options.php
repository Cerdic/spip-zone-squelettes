...
define(_SARKASPIP_TYPE_SECTEURS_SPECIALISES, 'config:motcle:config:config');
define(_SARKASPIP_FOND_SECTEURS_SPECIALISES, 'sarkaspip_agenda:-:sarkaspip_noisettes:sarkaspip_herbier');
?>