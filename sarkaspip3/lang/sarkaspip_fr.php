...
// Informations de configuration de chaque bloc
		...
		'cfg_inf_inc_formulaires' => 'Le menu des formulaires contient par d&eacute;faut l\'acc&egrave;s aux formulaires de contact, d\'inscription, de connexion/d&eacute;connexion. Vous pouvez aussi y inclure un lien vers le plan du site.',
		...
		'cfg_inf_inc_rechspip_pos' => 'Choisissez comment vous souhaitez ins&eacute;rer le formulaires de recherche SPIP: dans le chemin du bandeau ou dans une noisette positionn&eacute;e dans la colonne extra ou navigation 
		et regroupant, le cas &eacute;ch&eacute;ant, un formulaire de recherche externe.',
		...
		'cfg_inf_mini_agenda_resume_1' => 'R&eacute;sum&eacute; des &eacute;v&eacute;nements: liste les &eacute;v&eacute;nements &agrave; venir &agrave; partir de la date courante ou du premier jour du mois si celui-ci n\'est pas le mois courant.
		...
		'cfg_inf_accueil_intro_5' => '<em>Noisettes</em> : affichage, positionnement et contenu des noisettes',
		...
		'cfg_inf_form_dialogue' => 'Le formulaire de dialogue permet aux visiteurs connect&eacute;s d\'&eacute;changer avec d\'autres membres du site comme sur un IRC.',
		'cfg_inf_form_lettre' => 'Le formulaire de lettre d\'information permet aux visiteurs de s\'abonner &agrave sa diffusion au format HTML ou texte.',
		...
		'cfg_inf_dialogue_descriptif' => 'Vous pouvez r&eacute;diger un descriptif succinct pour pr&eacute;senter le fonctionnement du dialogue en direct (explication, étiquette...). Ce texte peut &ecirc;tre &eacute;crit en utilisant les raccourcis classiques de SPIP.',
		'cfg_inf_lettre_descriptif' => 'Vous pouvez r&eacute;diger un descriptif succinct pour pr&eacute;senter le contenu de vos lettres d\'information. Ce texte peut &ecirc;tre &eacute;crit en utilisant les raccourcis classiques de SPIP.',
		'cfg_inf_inscription_descriptif' => 'Vous pouvez r&eacute;diger un descriptif succinct pour pr&eacute;senter les avantages &agrave; devenir membre. Ce texte peut &ecirc;tre &eacute;crit en utilisant les raccourcis classiques de SPIP.',
		'cfg_inf_referencement_descriptif' => 'Vous pouvez r&eacute;diger un descriptif succinct agr&eacute;menter votre formulaire. Ce texte peut &ecirc;tre &eacute;crit en utilisant les raccourcis classiques de SPIP.',
		'cfg_inf_login1_descriptif' => 'Vous pouvez r&eacute;diger un descriptif succinct pour pr&eacute;senter les r&egrave;gles de r&eacute;f&eacute;rencment de votre site. Ce texte peut &ecirc;tre &eacute;crit en utilisant les raccourcis classiques de SPIP.',
...
// Labels des items de choix
		...
		'cfg_lbl_pixel' => 'px',
		'cfg_lbl_appliquer_padding' => 'D&eacute;sirez vous appliquer un padding sur les bords droit et gauche du wrapper : ',
		...
		'cfg_lbl_inc_position_3' => 'Chemin du bandeau (pensez alors &agrave; activer l\'affichage du chemin)',
		'cfg_lbl_inc_position_4' => 'Colonne extra ou navigation',
