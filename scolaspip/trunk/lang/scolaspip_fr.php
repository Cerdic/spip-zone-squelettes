...
// c
    ...
    'couleur_barre_texte' => '(#c4c4c4 par défaut)',
    'couleur_barre_over_legend' => 'Couleur de fond des liens survolés dans cette barre de liens&nbsp;:',
    'couleur_barre_over_texte' => '(#dddddd par défaut)',
    'couleur_bordure_legend' => 'Couleur des bordures&nbsp;:',
    'couleur_bordure_texte' => 'Sélectionnez la couleur des bordures (haut du menu horizontal et haut du pied de page), par défaut #ffcc00.',
    'couleur_fond_bandeau_legend' => 'Couleur de fond du bandeau&nbsp;: ',
    'couleur_fond_bandeau_texte'  => 'Sélectionnez la couleur de fond du bandeau, par défaut #4b4b4b (gris foncé). <br/>Pensez à l\'image (votre logo de site) qui se mettra par dessus.',
    'couleur_fond_menu_legend' => 'Couleur de fond du menu de navigation&nbsp;: ',
    'couleur_fond_menu_texte' => 'Sélectionnez la couleur de fond du menu de navigation de votre site, par défaut #F2E19D.',
    ...
    'couleur_liens_over_texte' => 'Sélectionnez la couleur des liens survolés dans le contenu de la page, par défaut #A85503.',
    'couleur_li_over_legend' => 'Éléments de listes survolés',
    'couleur_li_over_texte' => 'Sélectionnez la couleur de fond utilisée pour le survol des éléments de liste, par défaut #efefef.',
    ...
    'couleurs_bandeau_texte'=>'Par défaut&nbsp;: #fff (blanc). <strong>Paramètre actif si le mode « Bandeau élargi » est utilisé.</strong>',
