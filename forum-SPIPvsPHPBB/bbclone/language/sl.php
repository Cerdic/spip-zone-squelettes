 ...
 *
 * $Header: /cvs/bbclone/language/sl.php,v 1.18 2005/04/03 20:26:37 olliver Exp $
 *
...
"cc" => "Kokosovi otoki",
"cd" => "Kongo",
"cf" => "Srednjeafri¹ka republika",
"cg" => "Kongo",
"ch" => "©vica",
"ci" => "Slonoko¹èena Obala",
"ck" => "Cookovi otoki",
"cl" => "Èile",
"cm" => "Kamerun",
"cn" => "Kitajska",
...
"gr" => "Grèija",
"gs" => "Ju¾na Georgia in otoki Ju¾ni Sandwich",
"gt" => "Gvatemala",
"gu" => "Guam",
"gw" => "Gvineja Bissau",
"gy" => "Gvajana",
...
"ua" => "Ukrajina",
"ug" => "Uganda",
"uk" => "Zdru¾eno kraljestvo",
"um" => "Stranski zunanji otoki Zdru¾enih dr¾av",
"unknown" => "Neznano",
...
<li>search&nbsp;=&gt;&nbsp;iskani niz (èe obstaja)</li>
</ul>
