 ...
 *
 * $Header: /cvs/bbclone/language/es.php,v 1.46 2005/04/03 20:26:37 olliver Exp $
 *
...
// Address Extensions
"ac" => "Islas de la ascensi&oacute;n",
"ad" => "Andorra",
...
"gr" => "Grecia",
"gs" => "Sur de Georgia y islas Sandwich",
"gt" => "Guatemala",
"gu" => "Guam",
"gw" => "Guinea-Bissau",
"gy" => "Guyana",
...
"info" => "Information",
"int" => "Organizaciones",
"io" => "Territorio brit&aacute;nico del oceano &iacute;ndico",
"iq" => "Irak",
"ir" => "Iran",
"is" => "Islandia",
"it" => "Italia",
...
"so" => "Somalia",
"sr" => "Suriname",
"st" => "San Tome y Principe",
"su" => "Uni&oacute;n sovi&eacute;tica",
"sv" => "El Salvador",
"sy" => "Syria",
"sz" => "Swaziland",
...
"ve" => "Venezuela",
"vg" => "Islas v&iacute;rgenes(UK)",
"vi" => "Islas V&iacute;rgenes (US)",
"vn" => "Vietnam",
"vu" => "Vanuatu",
"wf" => "Wallis y islas Futuna",
"ws" => "Samoa",
"ye" => "Yemen",
"yt" => "Mayotte",
...
"navbar_Time_Stats" => "Estad&iacute;siticas temporales",
