...
function formulaires_spipr_educ_configure_sommaire_compteur_charger_dist($nom,$id) {
	...
	$valeurs['blocCSS']=$tab_sql2['parametre5'];
	return $valeurs;
}

function formulaires_spipr_educ_configure_sommaire_compteur_traiter_dist($nom,$id) {
