...
function formulaires_spipr_educ_themes_couleur_base_charger_dist() {
...
function formulaires_spipr_educ_themes_couleur_base_traiter_dist() {
	...
	elseif (in_array($nouvelle_couleur, spipr_educ_defintion_couleurs('theme_de_base'))) {
		sql_updateq(
			'spip_spipr_educ',
			array(
		...
		if (spipr_educ_modif_couleur_theme('theme_de_base',$nouvelle_couleur)=='ok') $retour = "Le choix de la couleur \""._T('spipr_educ:'.$nouvelle_couleur)."\" a &eacute;t&eacute; pris en compte.";
	}
