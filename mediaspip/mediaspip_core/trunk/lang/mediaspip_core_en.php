...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'description_autoriser_flux_podcast' => 'The podcast feed will concern only the medias of the site. Only MP3 and MP4 document types will be available in the feed. If you’ve chosen not to release the original documents, this choice is respected.', # MODIF
	...
	'legende_configuration_fichiers' => 'Providing files', # MODIF
