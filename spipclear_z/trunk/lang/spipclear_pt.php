...
// extrait automatiquement de http://trad.spip.org/tradlang_module/spipclear?lang_cible=pt
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'commentaires_fermes' => 'Os comentários para este post estão fechados',
	'commentaires_pour' => 'Comentários para',
	'contacts' => 'Contacts', # NEW
	'credits' => '<a href=>"http://www.spip.net/en">feita por SPIP</a>,
<a href=>"http://www.spip-contrib.net/Spip-Clear">vestido por Spip.Clear</a>',
	...
	// F
	'fil_atom' => 'feed atom',
	'fil_atom_commentaires' => 'feed atom comentários',
	'fil_rss' => 'feed rss',
	'fil_rss_commentaires' => 'feed rss comentários',

	// G
	'go_main' => 'Ir para o conteúdo',
	'go_search' => 'Vá para busca',
	'go_sidebar' => 'Vá ao menu',

	// H
	'hebergement' => 'hospedado por',

	// I
	'info_choix_theme' => 'Choisissez le thème que vous souhaitez utiliser pour votre blog', # MODIF

	// L
	'label_limite' => '', # NEW
	'label_nom_theme' => 'Saisissez le nom du thème perso (correspond &agrave xxxx du sous-répertoire squelettes/themes/xxxx/)', # MODIF
	'label_theme_defaut' => 'Thème par défaut (type DotClear)', # MODIF
	'label_theme_perso' => 'Thème perso (à définir ci-dessous)', # MODIF
	'langue' => 'linguagem',
	'langues' => 'línguas',
	'legend_layout' => 'Présentation', # MODIF
	'legend_theme' => 'Thème', # MODIF
	'lien' => 'Link',
	'lien_permanent' => 'Lien permanent', # NEW
	'liens' => 'Links',
	'lire_la_suite' => 'Lire la suite', # NEW
	'look_navigation' => 'Personnalisation du bloc de navigation', # NEW
	...
	'noisette_titre_lastposts' => 'Derniers billets', # NEW
	'noisette_titre_links' => 'Liste de sites', # NEW
	...
	'rss_pour' => 'Feed RSS comentários para',
	...
	'trackbacks_fermes' => 'Os trackbacks para este post est',
