...
//            - listing annuel, avec choix du mois de dŽbut de saison et du type d'affichage de la pagination
//            - planche contact
...
//               L'appel de ce filtre se fait ˆ l'intŽrieur de la boucle ARTICLES de recensement des articles-albums.
...
//            - logo : logo du premier document rencontrŽ ou logo de l'article si aucun document
...
// =======================================================================================================================================
// Auteur: Smellup
// Fonction : Insertion d'une bande de pagination spŽcifique au type de galerie choisi
// Utilisation : Doit etre appelee apres le recensement ˆ l'endroit ou aux endroits souhaitŽe de la page
// Arguments :
//            - page_choisie : si type_galerie=listing_annuel correspond a une annee sinon correspond au numero de planche
//            - filtre : -1 pour aucun filtre, 0 pour sans categorie, valeur>1 correspondant ˆ l'id du mot-clŽ caracterisant la categorie
