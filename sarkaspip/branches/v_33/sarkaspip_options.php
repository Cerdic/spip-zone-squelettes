...
if (!defined('_SARKASPIP_DEBUG_CFG_FONDS')) {
	define('_SARKASPIP_DEBUG_CFG_FONDS', 'non');
}

// Liste des pages de configuration dans l'ordre de presentation
if (!defined('_SARKASPIP_PAGES_CONFIG')) {
	define('_SARKASPIP_PAGES_CONFIG',
'accueil
