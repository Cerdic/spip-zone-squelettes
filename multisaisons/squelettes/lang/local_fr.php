...
'autre_article' => 'Autres articles',
'aecrit' => 'a &eacute;crit ',
'agenda_ajouter' => 'Ecrire dans l\'agenda.',
...
'abo_gestion' => 'Abonnement et gestion de votre compte',
'inscrit_acces' => 'apr&egrave;s inscription pour y avoir acc&egrave;s',
'archive' => 'archive',
'aide_clavier' => 'Aide sur les raccourcis clavier',
'affichage_fin' => 'Affiner l\'affichage',
...
'article_mes' => 'Mes derniers articles',
'article_mon' => 'Mon dernier article',
'article_last_redac' => 'Article en r&eacute;daction',
'article_last_propo' => 'Article propos&eacute;',
'article_last_ref' => 'Article refus&eacute;',
'article_last_poub' => 'Article jet&eacute;',
'article_last_pub' => 'Article publi&eacute;',
'article_redac_no' => 'Vous ne pouvez pas &eacute;crire d\'article.',
'article_vogue' => 'Les articles en vogue',
'article_total1' => 'Il y a au total',
'article_total2' => 'articles, cette page en affiche',
'abonnement_gerer' => 'G&eacute;rer mon abonnement',
'article_trouver' => 'n\'a pas &eacute;t&eacute; trouv&eacute; dans les articles.',
'article_dernier' => 'Les derniers articles',
'article_ajout_recent' => 'les articles modifi&eacute;s r&eacute;cemment',
'archi' => 'Architecture',
'archi_comp' => 'compl&eacute;tent le site',
'annu_lien' => 'annuaire de liens',
'article_dans' => 'Dans les articles',
'article_voir' => 'Voir l\'article',
'acces_prob' => 'pour tout probl&egrave;me d\'acc&egrave;s.',

// B
'bienvenue' => 'Bienvenue',
'bienvenue_sur' => 'Bienvenue sur ',
...
'rens_biographie'=> 'Renseigner ma biographie',
'breve_new' => 'br&egrave;ves
  de news',
'breve_dans' => 'Dans les  br&egrave;ves',
'breve_total1' => 'Il y a au total',
'breve_total2' => 'br&egrave;ves, cette page en affiche',
'breve_trouver' => 'n\'a pas &eacute;t&eacute; trouv&eacute; dans les br&egrave;ves.',
...
'bloogletter_alerte_edit' => 'Attention : ce message peut &ecirc;tre modifi&eacute; par tous les administrateurs du site et est re�u par tous les abonn&eacute;s. N\'utilisez la lettre d\'information que pour exposer par mail des &eacute;v&eacute;nements importants de la vie du site.',
...
'bloogletter_message_arch' => 'Message archiv&eacute;',
...
'bloogletter_aff_redac' => 'Courriers en cours de r&eacute;daction',
'bloogletter_aff_encours' => 'Courriers en cours d\'envoi',
'bloogletter_aff_envoye' => 'Courriers envoy&eacute;s',
'bloogletter_aff_lettre_auto' => 'Lettres des nouveaut&eacute;s envoy&eacute;es',
'bloogletter_aff_envoye' => 'Courriers envoy&eacute;s',
'info_bloogletter_auto' => 'La bloOgletter pour spip peut envoyer r&eacute;guli&egrave;rement aux inscrits, l\'annonce des derni&egrave;res nouveaut&eacute;s du site (articles et br&egrave;ves r&eacute;cemment publi&eacute;s).',
'info_bloogletter_heberg' => 'Certains h&eacute;bergeurs d&eacute;sactivent l\'envoi automatique de mails depuis leurs serveurs. Dans ce cas, les fonctionnalit&eacute;s suivantes de la bloogletter pour SPIP ne fonctionneront pas',
...
'bloogletter_aff_incorect_envoi_mail2' => 'd&eacute;crire
...
'bloogletter_interpre' => 'Une mauvaise
  interpr&eacute;tation de l\'encodage par un serveur, un logiciel courrier ou
  un webmail est souvent &agrave; l\'origine du probl&egrave;me.',
'breve_dernier' => 'Derni&egrave;res br&egrave;ves',
'bloogletter_derniere' => 'Les derni&egrave;res newsletter',
'bloogletter_ameliorer' => 'Am&eacute;liorez votre
  lettre',
...
'conect_coment' => 'vous
&ecirc;tes connect&eacute;, vous pouvez
  commenter',
...
'diff_pgp' => 'Diffuser ma cl&eacute; publique PGP',
'dialoguer' => 'Dialoguer',
...
'docu_trouver' => 'n\'a pas &eacute;t&eacute; trouv&eacute; dans les documents du site.',
'dialoguer' => 'Dialoguer',
...
'evene_tous' => 'Afficher tous les &eacute;v&eacute;nements',
'ecrit_passe' => 'Passer &agrave; l\'&eacute;criture',
'evene_grille' => 'Pas d\'&eacute;v&eacute;nement ce jour. Cherchez dans la grille.',
'evene_futur' => 'les prochains &eacute;v&eacute;nements',
'evene_date' => 'Pas d\'&eacute;v&eacute;nement r&eacute;f&eacute;renc&eacute; ce mois. Changez de date.',
...
fils de',
'forum_dernier' => 'les derniers messages des forums',
'forum_dans' => 'Dans les forums',
'forum_total1' => 'Il y a au total',
'forum_total2' => 'discussions, cette page en affiche',
'forum_trouver' => 'n\'a pas &eacute;t&eacute; trouv&eacute; dans les forums de discussion.',
'forum_voir_total1' => 'Voir les',
'forum_voir_total2' => 'discussions de ce forum',
'forum_cookies' => 'Pour r&eacute;pondre dans les forums, votre navigateur doit accepter les cookies 
 	  de',
...
//G
'glossaire' => 'Glossaire',
'glossaire_choix' => 'Choisissez une lettre dans le glossaire technique.',
'gestion' => 'Gestion',
...
'logo_origine' => 'Mon logo d\'origine',
'logo_ajout' => 'Ajouter mon logo',
'logo_saison' => 'Mon logo saisonnier',
'lieu' => 'Localisation',
'lettre_d_information' => 'Lettre d\'information',
'texte_lettre_information' => 'Voici la lettre d\'information du site',
'localiser_iti' => 'Localiser l\'itin&eacute;raire sur une carte imprimable',
'localiser_point' => 'Localiser sur une carte imprimable',
...
'membres_eject' => 'Ejecter un membre p&eacute;nible',
'message' => 'Message',
'message_date' => 'Post&eacute; le ',
'message_sujet' => 'Sujet ',
'messages' => 'Messages',
'mes_messages' => 'Mes messages',
...
'messages_abu' => 'Effacer un message abusif',
...
'modif_profil_maj' => 'Modifier mon profil',
...
'nouveau' => 'Nouveau',
'news_page' => 'page
  de nouveaut&eacute;s',
'news' => 'News',
'news_de' => 'Les news de',
'news_plus' => 'Plus de news',
'news_site' => 'Les news du site',
...
//P
'page_accessible' => 'Cette page est accessible aux membres de',
...
'suivre_forum' => 'Suivre mes discussions',
'profil' => 'Mon profil',
...
'date_de_redaction' => 'date de r&eacute;daction',
'rubriques' => 'rubriques',
'rubrique' => 'rubrique',
'recherche_go' => 'Lancez votre recherche',
'recherche_form' => 'Entrez votre recherche dans le formulaire puis validez.',
'recherche_google' => 'Vous pouvez &eacute;largir votre recherche aux moteurs ci-dessous',
'recherche_blabla' => 'Lancez une recherche sur le moteur interne du site : 
    Les mots de moins de quatre lettres ne sont pas indexés
    par le moteur interne. Utilisez un seul mot pour cibler votre recherche',
'recherche_savoir' => 'A savoir',
'rub_dans' => 'Dans les rubriques',
'rub_total1' => 'Il y a au total',
'rub_total2' => 'rubriques, cette page en affiche',
...
'rss_ajout_site' => 'Dans votre lecteur RSS,  votre logiciel courrier RSS, votre agr&eacute;gateur RSS,
ajoutez cette adresse  pour afficher les news du site entier',
'rss_site_entier' => 'Profiter du site entier',
'rss_java' => 'Des javascript pour sites web',
'rss_blabla_java' => 'Un site web non &eacute;quip&eacute; d\'agr&eacute;gateur en ligne peut aussi
    profiter du contenu de ',
'rss_blabla_java3' => 'Affichez les news de la rubrique ',
'rss_blabla_java2' => '    Ins&eacute;rez
    ce Javascript entre les balises body de votre page html',
'rss_css' => 'Le contenu de la rubrique apparaitra comme dans la d&eacute;monstration ci-contre.
  Vous pouvez en modifier le style css.',
'rss_ss_css' => 'Un site web non &eacute;quip&eacute; d\'agr&eacute;gateur en ligne peut aussi profiter du contenu
    de',
'rss_ss_css2' => 'Ins&eacute;rez ce Javascript entre les balises body de votre
    page html',
...
'rss_bou' => 'boutons',
'rss_fils3' => 'des
                fils RSS au pied des pages. Sur le bouton, r&eacute;cup&eacute;rez l\'adresse
                du fil d\'information de la rubrique, du forum ou du site entier.',
...
'stats_acc2' => 'visiteurs uniques
par jour.',
'stats_acc3' => 'visiteurs
ont pulv&eacute;ris&eacute;
le score!',
'stats_acc4' => 'La base d\'articles est consult&eacute;e environ',
'stats_acc5' => 'fois
par jour.',
'stats_acc6' => 'contient',
...
'site_total1' => 'Il y a au total',
'site_total2' => 'sites, cette page en affiche',
'site_trouver' => 'n\'a pas &eacute;t&eacute; trouv&eacute; dans les descriptifs des sites web partenaires.',
'rss' => 'syndication RSS',
'rss_aff' => 'Afficher le contenu dynamique RSS de',
'source' => 'Source', 
'site_propose' => 'Proposer un site',
'sur' => 'sur',
'supprimer_message' => 'Suppression',
'supprimer_message_notice' => 'En cliquant vous supprimez le message de',
...
//V
'voir' => 'voir',
'voir_egal' => 'A voir &eacute;galement',
'vu_web' => 'Vu sur le web',
'visiteur' => 'visiteur',
'visiteur_statut_no' => 'Votre statut de visiteur ne vous permet pas d\'ajouter un profil. Vous pouvez n&eacute;anmoins g&eacute;rer votre abonnement ci-dessous.',
'nb_de_visites' => 'nb de visites',
