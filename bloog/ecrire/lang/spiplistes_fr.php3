...
//_
'_aide' => 'SPIP-Listes vous permet d\'envoyer une lettre &agrave; des abonn&eacute;s. Vous pouvez utiliser un patron, &eacute;crire un texte simple ou
composer votre courrier en HTML. 
<br /><br /> Les abonn&eacute;s d&eacute;finissent eux-m&ecirc;mes en ligne leur statut d\'abonnement, les listes auxquelles ils s\'abonnent et le format
dans lequel ils souhaitent recevoir les courriers (HTML/texte). <br /><br />Tout message sera traduit automatiquement en format texte pour les abonn&eacute;s qui en ont fait la demande.<br /><br /><b>Note :</b><br />L\'envoi des mails peut prendre quelques minutes : les lots partent peu &agrave; peu quand les utilisateurs parcourent le site public. Vous pouvez aussi provoquer manuellement l\'envoi des lots en cliquant sur le lien "suivi des envois" pendant un envoi.',
...
'adresses_importées' => 'Les adresses conformes ont été importées',
...
'charger_patron' => 'Choisir un mod&egrave;le',
...
'sujet_clos_texte' => 'Ce sujet est clos, vous ne pouvez pas y poster.',
 ...
 //T
'texte_boite_en_cours' => 'SPIP-Listes envoie un message automatique en ce moment. <p> Vous pouvez provoquer l\'envoi acc&eacute;l&eacute;r&eacute; des lots grâce au lien ci-dessous.</p> <p>Cette boite disparaitra une fois l\'envoi achev&eacute;.</p>',
...
'adresse_deja_inclus' => 'L\'adresse $mail est déjà abonnée',
...
'env_esquel' => 'Envoi programmé du squelette',
'env_maint' => 'Envoyer maintenant',
'envoyer' => 'envoyer le mail',
'envoyer_a' => 'Envoi vers',
'erreur' => 'Erreur',
'erreur_import' => 'Le fichier d\'import présente une erreur à la ligne $ligne_nb près de :',
...
'listes_internes' => 'Listes de diffusion internes<br /><i>Au moment de l\'envoi d\'un message, ces listes sont proposées parmi les destinataires</i>',
...
'non_program' => 'Il n\'y a pas de message automatique programmé pour cette liste.',
...
'prochain_envoi_prevu' => 'Prochain envoi pr&eacute;vu dans ',
...
'sans_envoi' => 'Attention, l\'adresse email de test que vous avez fournie ne correspond à aucun abonné, <br />l\'envoi ne peut se faire, veuillez reprendre la procédure<br /><br />',
'squel' => 'Squelette : &nbsp;',
...
'abo_listes' => '<b>Abonnement aux listes de diffusion de </b>',
...
'erreur_sans_destinataire' => 'Erreur : aucun destinataire ne peut être trouvé pour ce message',
...
'patron_erreur' => 'Le patron spécifié ne donne pas de résulat avec les paramètres choisis',
...
'inscription_response' => 'Vous êtes abonné à la liste d\'information du site ',
'inscription_responses' => 'Vous êtes abonné aux listes d\'informations du site ',
'inscription_liste' => 'Vous avez choisi de recevoir les messages adressés à la liste suivante : ',
'inscription_listes' => 'Vous avez choisi de recevoir les messages adressés aux listes suivantes : ',
