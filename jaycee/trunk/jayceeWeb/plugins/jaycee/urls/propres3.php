...
function generer_url_rubrique($id_rubrique) {
	...
	if ($url)
		return $url.'-rub'.$id_rubrique._terminaison_urls_propres;
	else
...
function generer_url_breve($id_breve) {
	...
	if ($url)
		return $url.'-brv'.$id_breve._terminaison_urls_propres;
	else
...
function generer_url_mot($id_mot) {
	...
	if ($url)
		return $url.'-mot'.$id_mot._terminaison_urls_propres;
	else
...
function generer_url_auteur($id_auteur) {
	...
	if ($url)
		return $url.'-aut'.$id_auteur._terminaison_urls_propres;
	else
...
function generer_url_site($id_syndic) {
	...
	if ($url)
		return $url.'-sit'.$id_syndic._terminaison_urls_propres;
	else
