 ...
 *
 * $Header: /cvs/bbclone/show_views.php,v 1.32 2005/04/08 10:35:34 olliver Exp $
 *
...
function bbc_which_whois($addr) {
  ...
  return "<script type=\"text/javascript\">\n"
        ."<!--\n"
        ."document.write('&#040;<a href=\"javascript:go(\'"
        .urlencode(empty($url) ? "ws.arin.net/cgi-bin/whois.pl?queryinput=$addr" : $url)
        ."\')\" rel=\"nofollow\" title=\"Whois\">Whois</a>&#041;');\n"
        ."-->\n"
        ."</script>\n"
        ."<noscript>(<span title=\"http://$url\">Whois</span>)</noscript>\n"
        ."&nbsp;\n";
}
