 ...
 *
 * $Header: /cvs/bbclone/show_detailed.php,v 1.83 2005/04/08 10:35:34 olliver Exp $
 *
...
function bbc_show_connect_field($connect, $field, $lng, $titles = false) {
  global $BBC_IMAGES_PATH, $BBC_LIB_PATH, $_;
  ...
  switch ($field) {
    ...
    case "referer":
      ...
      return "<div align=\"left\">&nbsp;\n"
            ...
            ."<!--\n"
            ."document.write('<a href=\"javascript:go(\'".urlencode($url)."\')\" rel=\"nofollow\" "
            ."title=\"$str\">$str</a>');\n"
            ."-->\n"
            ."</script>\n"
            ."<noscript><span title=\"http://$url\">$str</span></noscript>\n"
            ."</div>\n";
