...
******************************************************************/
function balise_EVANBREPREMSITERUB($p) {
    $test_nbre=spip_query("SELECT nom_image FROM eva_habillage_images WHERE nom_habillage='Defaut' AND type='nbre' AND nom_div ='nbre_rubrique_sites_ref'");
