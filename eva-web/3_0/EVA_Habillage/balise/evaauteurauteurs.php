...
******************************************************************/
function balise_EVAAUTEURAUTEURS($p) { 
    $test_nav=spip_query("SELECT nom_image FROM eva_habillage_images WHERE nom_habillage='Defaut' AND type='bloc' AND nom_div ='auteur_auteurs'");
