...
$EvaHabillageTable__images_key = array( 
"PRIMARY KEY" => "id");

$GLOBALS['tables_principales']['eva_habillage'] = 
    array('field' => &$EvaHabillageTable, 'key' => &$EvaHabillageTable_key);
 
$GLOBALS['tables_principales']['eva_habillage_themes'] = 
    array('field' => &$EvaHabillageTable_themes, 'key' => &$EvaHabillageTable_themes_key);
   
$GLOBALS['tables_principales']['eva_habillage_images'] = 
