...
// extrait automatiquement de https://trad.spip.net/tradlang_module/eva?lang_cible=it
...
$GLOBALS[$GLOBALS['idx_lang']] = array(
 ...
 <p>È formalmente vietato raccogliere e utilizzare le informazioni disponibili sul sito a scopi commerciali.</p>
...
corrispondeva a un progetto di portale d’Intranet istituzionalem installato sui 
 ...
 <div style="text-align:center;"><a rel="licence" target="_blank" href="http://katolaz.homeunix.net/gplv3/gplv3-it-final.html"><img alt="Licence GNU GPL" style="border-width:0" width="80" height="100" src="http://www.fsf.org/graphics/philosophical-gnu-sm.jpg"/></a></div>', # MODIF
