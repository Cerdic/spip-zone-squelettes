...
array('form_inscription','sommaire rubrique article breve site auteur entete pied','Formulaire d\'inscription. Disponible si on a autoris&eacute; l\'inscription des r&eacute;dacteurs dans les pages de configuration de SPIP. On pourra ajouter les règles CSS suivantes pour am&eacute;liorer la pr&eacute;sentation du formulaire :<br /><em>legend {margin-top:6px;} #nom_inscription, #mail_inscription {width:80%;}</em>.','Olivier Gautier'),
