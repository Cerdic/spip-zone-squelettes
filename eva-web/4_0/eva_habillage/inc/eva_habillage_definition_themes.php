...
//Définition des sélecteurs de personnalisation d'EVA (on regroupe les sélecteurs en fonction du thème et de la propriété concernée)
   ...
   //Fond des titres de l'entête
    ...
    $texte_barres_entete_color = array('h3','h3.titre','h3.titre a','div#contenu h3','legend','#forum .bouton a','.bloc .titre','.divers h4','table.spip tr.row_first th','div#contenu div.ps h4','div#menu h3.titre','div#menudroit h3.titre','table.spip tr.row_first','div#contenu div.lien','.contenu .lien','div#contenu div.notes h4','div#contenu h4.titre','div#contenu h3.titre','#forum ul.forum div.titre h4');
