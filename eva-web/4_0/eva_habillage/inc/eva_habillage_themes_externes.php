...
'Black Apple' => array(
    ...
    "('', 'perso', 'Defaut', '#forum .bouton a:first-letter, .divers h4:first-letter, div#contenu div.lien:first-letter, div#contenu div.ps h4:first-letter, div#contenu div.notes h4:first-letter, div#contenu h4.titre:first-letter, div#contenu h3:first-letter, div#contenu .bloc h3:first-letter, div#contenu .bloc h3.titre:first-letter, div#menu h3:first-letter, .divers h4:first-letter, h3:first-letter, div#contenu .edito h3.titre:first-letter {font-size:130%;}', '', '', '', '', '')",
...
'Blanche' => array(
    /* Thème créé par Olivier Gautier et inspiré du site CssZenGarden*/
    "habillage" => "eva_style_menu_a_droite.css",
...
'Un air de LCS-Caen' => array(
    ...
    "habillage" => "eva_style_menu_a_droite.css",
    "theme" => "('', 'Defaut', '#757d88', '#ffffff', '#ffffff', '#ffee99', '#ffcc32', '#595d66', '#999999', '#999999', '#cccccc', 'transparent', '#ffcc33', '#595d66', '#595d66', '#ffcc33', '#ffffff', '#ffffff', '#ffcc32', '#eeeeee', '#dddddd', '', '#003366', '#003366', '#003366', '#ffffff', '#336699', '#336699', '#336699', '#010199', '#010199', '#010199', '#336699', '#336699', '#336699', '#336699', '#336699', '#f1f1c5', '#336699', '#f1f1c5', '#5c85ad', '#ff6600', '#5c85ad', '#ff6600', '#5c85ad', '#ff6600', 'transparent', '0px', '', '#cccccc', '2px', '', 'transparent', '0px', '', 'transparent', '0px', '', 'transparent', '0px', '', 'transparent', '0px', '', 'transparent', '0px', '', '#cccccc', '3px', '', 'transparent', '0px', '', '', '', '', '', '50px', '', '')",
    "images" => array(
