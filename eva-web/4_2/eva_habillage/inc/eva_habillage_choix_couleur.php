...
function eva_habillage_choix_couleur() {
	...
	<form name=colorform>
		...
		<a>
		<table><tr><td><img usemap="#colmap" src="<?php echo _DIR_PLUGIN_EVA_HABILLAGE."img_pack/eva_colortable.gif"; ?>" width=289 height=67 style="border:none;float:left;margin-right:10px;" /></a>
		</td><td>
		<input type=text name=hexval size=10 readonly="readonly" /></td></tr></table>
	</form>
<?php } ?>