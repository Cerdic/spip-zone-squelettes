...
'Vide' => array(
    ...
    "habillage" => "eva4_menu_gauche.css",
    "theme" => "('', 'Defaut', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '')",
    "images" => array()
    ),
...
'Black Tree' => array(
    ...
    "images" => array(
    "('', 'image', 'Defaut', 'image_page', 'Black/Black_page.png', 'left', 'bottom', 'repeat-x', 'scroll')",
    "('', 'image', 'Defaut', 'image_menu_on', 'Black/BlackBrown_entete_liens.png', 'left', 'top', 'repeat-x', 'scroll')",    "('', 'image', 'Defaut', 'image_titres', 'Black/BlackApple_titres_secteurs.png', 'left', 'bottom', 'repeat-x', 'scroll')",
...
'Plage 2' => array(
    ...
    "('', 'image', 'Defaut', 'image_page', 'Plage/Poisson1.gif', 'left', 'bottom', 'no-repeat', 'scroll')",
    "('', 'perso', 'Defaut', 'div#menu {padding-left:0px;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#page {margin-top:0px;}', '', '', '', '', '')",
    ...
    "('', 'perso', 'Defaut', 'div#conteneurseul, div#conteneurseul div#contenu {margin : 0 0 0 258px;}', '', '', '', '', '')",
...
'Un air de Sarka-SPIP' => array(
    /* Thème créé par Olivier Gautier, sur un modèle issu du site Sarka-SPIP */
    "habillage" => "eva4_3colonnes.css",
    ...
    "('', 'perso', 'Defaut', 'div#contenu .bloc h3:first-letter , div#contenu .bloc h3:first-letter , h3 , div#contenu h3 , h3:first-letter , div#contenu h3:first-letter {color:#990000;}', '', '', '', '', '')",
...
'Fille ou garcon ?' => array(
    ...
    "('', 'perso', 'Defaut', 'ul.liens {text-align:left}', '', '', '', '', '')",
...
'Souris' => array(
    ...
    "('', 'perso', 'Defaut', 'body, div#page {margin-top:0; margin-bottom:0;}', '', '', '', '', '')",
...
'Souris 2' => array(
    /* Thème créé par Olivier Gautier et adapté par Pascal Rougier */
    "habillage" => "eva4_basic_menu_gauche.css",
    ...
    "('', 'perso', 'Defaut', 'div#entete h1 span , div#entete h2 span {border:2px solid #C0C0C0;}', '', '', '', '', '')",
     ...
     "('', 'perso', 'Defaut', '.bloc {padding-left:10px; padding-right:10px;}', '', '', '', '', '')",    
...
'Orchidee' => array(
    ...
    "('', 'perso', 'Defaut', 'div#menu {margin-top:280px;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'body {font-size: 90%;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#menu {border:1px solid #843608;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#contenu{padding-top:80px;}', '', '', '', '', '')",
    "('', 'image', 'Defaut', 'image_impairs', 'orchidees/barre.jpg', 'left', 'bottom', 'repeat-x', 'scroll')",
    "('', 'image', 'Defaut', 'image_ecran', 'orchidees/orchidee.JPG', '10px', 'top', 'no-repeat', 'scroll')",
    "('', 'image', 'Defaut', 'image_pairs', 'orchidees/barre.jpg', 'left', 'bottom', 'repeat-x', 'scroll')",
    "('', 'perso', 'Defaut', 'div#arborescence{text-align:right; padding-right:15px;}', '', '', '', '', '')",        
    ), ),
...
'Blanche' => array(
    ...
    "('', 'perso', 'Defaut', 'body {font-size: 90%;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#menu {border:1px solid #AEBE61;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#contenu{padding-top:80px;}', '', '', '', '', '')",
    "('', 'image', 'Defaut', 'image_impairs', 'orchidees/barre.jpg', 'left', 'bottom', 'repeat-x', 'scroll')",
    "('', 'image', 'Defaut', 'image_ecran', 'blanche/blanche1.jpg', 'right', 'top', 'no-repeat', 'scroll')",
    "('', 'perso', 'Defaut', 'div#entete h1 span {color:#AEBE61; font-size:120%; letter-spacing:0.1em; font-weight:lighter;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#menu {margin-top:220px;}', '', '', '', '', '')",
    "('', 'image', 'Defaut', 'image_pairs', 'orchidees/barre.jpg', 'left', 'bottom', 'repeat-x', 'scroll')",
    ), ),
...
'Un air de LCS-Caen' => array(
    /* Thème créé par les services informatiques de l'académie de Caen*/
    "habillage" => "eva4_basic_menu_droite.css",
    "theme" => "('', 'Defaut', '#757d88', '#ffffff', '#ffffff', '#ffee99', '#ffcc32', '#595d66', '#999999', '#999999', '#cccccc', 'transparent', '#ffcc33', '#595d66', '#595d66', '#ffcc33', '#ffffff', '#ffffff', '#ffcc32', '#eeeeee', '#dddddd', '', '#003366', '#003366', '#003366', '#ffffff', '#336699', '#336699', '#336699', '#010199', '#010199', '#010199', '#336699', '#336699', '#336699', '#336699', '#336699', '#f1f1c5', '#336699', '#f1f1c5', '#5c85ad', '#ff6600', '#5c85ad', '#ff6600', '#5c85ad', '#ff6600', 'transparent', '0px', '', '#cccccc', '2px', '', 'transparent', '0px', '', 'transparent', '0px', '', 'transparent', '0px', '', 'transparent', '0px', '', 'transparent', '0px', '', '#cccccc', '3px', '', 'transparent', '0px', '', '', '', '', '', '60px', '', '')",
    "images" => array(
    "('', 'image', 'Defaut', 'image_page', 'lcs/background_s.gif', 'left', 'top', 'repeat', 'scroll')",
    ), ),


'Ecrire en ligne 72' => array(
    /* Thème créé sur le site http://www.ecrire-en-ligne92.ac-versailles.fr/ */
    "habillage" => "eva4_basic_menu_droite.css",
    "theme" => "('', 'Defaut', '#F0F0F0', '#FFF', '#FFF', '#336699', '#336699', '#CCC', '#CCC', '#8BA4C5', '#FFF', '#CCC', '#244362', '#336699', '#336699', '#244362', '#244362', '#244362', '#3875B2', '#CCC', '#B1B1B1', '', '#003333', '#FFF', '#333', '#336699', '#FFF', '#FFF', '#FFF', '#FFF', '#FFF', '#336699', '#99CCFF', '#99CCFF', '#FFF', '#FFF', '#FFF', '#003333', '#003333', '#FFF', '#244362', '#336699', '#244362', '#336699', '#244362', '#336699', '#000', '1px', 'solid', '#000', '1px', 'solid', '', '', 'none', '', '', 'none', '', '', 'none', '#000', '1px', 'solid', '', '', 'none', '', '', 'none', '', '', 'none', '', '', '', '', '100px', '', '')",
    "images" => array(
    ), ),
...
'Seule...' => array(
    ...
    "('', 'perso', 'Defaut', 'div#contenu {border-left:1px solid #555;border-bottom:1px solid #555; margin-top:216px; background-color:#F4F4F4;}', '', '', '', '', '')",
    ...
    "('', 'image', 'Defaut', 'image_page', 'seule/seule.jpg', 'right', 'top', 'no-repeat', 'scroll')",
    "('', 'image', 'Defaut', 'image_impairs', 'orchidees/barre.jpg', 'left', 'bottom', 'repeat-x', 'scroll')",
    "('', 'perso', 'Defaut', 'ul#logo-pied, ul#pied {line-height:30%;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div #conteneurseul, div#page div#entetediaporama {padding-top:210px;}', '', '', '', '', '')",
    "('', 'image', 'Defaut', 'image_pairs', 'orchidees/barre.jpg', 'left', 'bottom', 'repeat-x', 'scroll')",
    ), ),
...
'Automne maritime' => array(
    ...
    "('', 'image', 'Defaut', 'image_edito_titre', 'foret/foret_pied.jpg', 'left', 'center', 'repeat', 'scroll')",
    ...
    "('', 'perso', 'Defaut', 'div#entete ul.liens {text-align:left;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#arborescence{padding-left:15px; border-bottom:6px solid #FFF;}', '', '', '', '', '')",
    ), ),
...
'Soleil' => array(
    ...
    "('', 'perso', 'Defaut', 'div#arborescence{text-align:right;padding-right:15px; padding-left:440px;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'ul#logo-pied, ul#pied {border-top:6px solid #786343;line-height:30%;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'body {font-size: 90%; margin-bottom:0; margin-top:0;}', '', '', '', '', '')",
    "('', 'image', 'Defaut', 'image_impairs', 'orchidees/barre.jpg', 'left', 'bottom', 'repeat-x', 'scroll')",
    "('', 'image', 'Defaut', 'image_pairs', 'orchidees/barre.jpg', 'left', 'bottom', 'repeat-x', 'scroll')",
...
'Blue-Pigment-CC' => array(
    ...
    "('', 'perso', 'Defaut', '#forum .bouton a {color:#1183DA;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#entete .menulangue {background-color:#1183DA;border-color:#323F76;}', '', '', '', '', '')",
...
'Purple-Pigment-CC' => array(
    /* Thème graphique adapté de Blue Pigment sous licence Creative Commons Attribution 2.5 License, adaptation réalisée par Olivier Gautier */
    "habillage" => "eva4_basic_3colonnes.css",
    "theme" => "('', 'Defaut', '', '#8E0AE7', '', '', '', '', '', '', '', '', '', '#330055', '#330055', '', '', '', '', '', '', '', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#55DD00', '#ffffff', '#ffffff', '#ffffff', '#ffffff', '#55DD00;font-weight:bolder', '', '#ffffff', '#55DD00;font-weight:bolder', '', '#ffffff', '#ffffff', '#ffffff', '#ffffff;font-weight:bolder', '#ffffff;text-decoration:underline', '#ffffff;font-weight:bolder', '#ffffff;text-decoration:underline', '#ffffff;font-weight:bolder', '#ffffff;text-decoration:underline', '', '', '', '#B95AF8', '5px', 'solid', '', '', '', '', '', '', '', '', '', '#B95AF8', '5px', 'solid', '', '', '', '', '', '', '', '', '', '', '', '', '', '175px', '', '')",
    "images" => array(
    "('', 'perso', 'Defaut', 'div#conteneur{padding-top:14px;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'ul#pied a, ul#pied li.on a {color:#B95AF8; font-weight:bolder;}', '', '', '', '', '')",
    "('', 'image', 'Defaut', 'image_page', 'BluePigment/violet_contenu_haut.jpg', 'left', '197px', 'repeat-x', 'scroll')",
    "('', 'perso', 'Defaut', '.menulangue {right:23.05%;bottom:10px;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#entete h1 {top:50px;margin-right:60px;left:50px;font-size:40px;}', '', '', '', '', '')",
    "('', 'image', 'Defaut', 'image_bloc', 'BluePigment/bloc_violet.png', 'left', 'top', 'repeat', 'scroll')",
    "('', 'image', 'Defaut', 'image_edito', 'BluePigment/bloc_violet.png', 'left', 'top', 'repeat', 'scroll')",
    "('', 'image', 'Defaut', 'image_barre_entete_arborescence', 'BluePigment/arbo_violet.png', 'left', 'top', 'repeat-x', 'scroll')",
    "('', 'image', 'Defaut', 'image_entete_page', 'BluePigment/entete_haut.png', 'left', 'top', 'repeat-x', 'scroll')",
    "('', 'perso', 'Defaut', 'div.bloc h3.titre {border-bottom:#B95AF8 solid 2px;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'ul#sommaire{border:#55DD00 solid 5px;background-color:transparent;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'hr {border-width:1px;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'h3 {border-style:none;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', 'div#entete .menulangue {background-color:#8E0AE7;border-color:#B95AF8;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', '#forum .bouton a:hover {background-color:#8E0AE7;color:#ffffff;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', '#forum .bouton a {color:#8E0AE7;}', '', '', '', '', '')",
    "('', 'perso', 'Defaut', '.rainette_infos,div#contenu .rainette_infos h2 .ville, fieldset{color:#8E0AE7;}', '', '', '', '', '')",
    "('', 'bloc', 'Defaut', 'Blue-Pigment-CC', 'oui', '1', '', 'perso', 'pied')",
    ), ),


'Zen' => array(
    /* Thème graphique réalisée par Olivier Gautier */
    "habillage" => "eva4_basic_menu_droite.css",
    "theme" => "('', 'Defaut', '#fff', 'transparent', 'transparent', '', '', '', '', '#8FA4D8', '', '', '', '', '', '', '', '', '', '', '', '', '#111', '#111', '#111', '#fff', '#111', '#000', '#111', '#789853', '#789853', '#789853; text-decoration:underline', '#000', '', '#111', '#000', '', '#fff', '#111', '#111', '#5284DD;text-decoration:underline', '#5284DD;text-decoration:none', '#5284DD;text-decoration:underline', '#5284DD;text-decoration:none', '#5284DD;text-decoration:underline', '#5284DD;text-decoration:none', '', '', 'none', '', '', '', '', '', 'none', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '800px', '200px', '', '540px', '140px', '', '')",
	"images" => array(
	...
	"('', 'perso', 'Defaut', '.edito .titre {text-align:left;text-decoration:none;padding-bottom:10px;}', '', '', '', '', '')",
	...
	"('', 'perso', 'Defaut', 'div#menu h3.titre {color:#fff;font-weight:bolder;font-size:120%;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', 'fieldset {width:80%;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', 'legend {margin-top:6px;} #nom_inscription, #mail_inscription {width:70%;}', '', '', '', '', '')",
	"('', 'image', 'Defaut', 'image_menu', 'zen/shamrock_for_march_natha_01.png', 'right', 'top', 'no-repeat', 'scroll')",
	"('', 'perso', 'Defaut', 'div#conteneurseul div#contenu {border-style:none;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', '.titre {margin-left:0;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', 'div#contenu .titre {background-image : url(/rep_eva_habillage/mon_image/zen/ban.jpg); background-position : left bottom; background-repeat : no-repeat; background-attachment : scroll;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', 'div#conteneurseul {border:2px solid #5284DD; background-color:#fff;background-image : url(/rep_eva_habillage/mon_image/zen/shamrock_for_march_natha_01.png); background-position : right top; background-repeat : no-repeat; background-attachment : scroll;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', '#formrecherche {background-color:transparent;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', 'ul#pied li {border-left-style:none;} ul#pied li a {text-decoration:underline;} ul#pied li a:hover{color:#333;text-decoration:none;}', '', '', '', '', '')",
	...
	"('', 'image', 'Defaut', 'image_ecran', 'zen/tico24.jpg', 'left', 'top', 'repeat-x', 'fixed')",
	"('', 'perso', 'Defaut', 'ul.liens {display:none;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', 'ul#logo-pied {display:none;}', '', '', '', '', '')",
	"('', 'perso', 'Defaut', 'div#conteneur div#contenu {background-image : url(/rep_eva_habillage/mon_image/zen/conskeptical540.jpg); background-position : left bottom; background-repeat : no-repeat; background-attachment : scroll;}', '', '', '', '', '')",
	"('', 'bloc', 'Defaut', 'entete_arborescence', 'non', '2', '', '', 'entete')",
	"('', 'bloc', 'Defaut', 'pied_classique', 'non', '2', '', '', 'pied')",
	"('', 'bloc', 'Defaut', 'pied_logos', 'non', '1', '', '', 'pied')",
	"('', 'bloc', 'Defaut', 'pied_zen', 'centre', '9', '', 'perso', 'sommaire')",
	"('', 'bloc', 'Defaut', 'pied_zen', 'centre', '9', '', 'perso', 'article')",
	"('', 'bloc', 'Defaut', 'pied_zen', 'centre', '9', '', 'perso', 'site')",
	"('', 'bloc', 'Defaut', 'pied_zen', 'centre', '9', '', 'perso', 'breve')",
	"('', 'bloc', 'Defaut', 'pied_zen', 'centre', '9', '', 'perso', 'rubrique')",
	"('', 'bloc', 'Defaut', 'pied_zen', 'centre', '9', '', 'perso', 'auteur')",
	"('', 'bloc', 'Defaut', 'arborescence_zen', 'centre', '0', '', 'perso', 'sommaire')",
	"('', 'bloc', 'Defaut', 'arborescence_zen', 'centre', '0', '', 'perso', 'article')",
	"('', 'bloc', 'Defaut', 'arborescence_zen', 'centre', '0', '', 'perso', 'site')",
	"('', 'bloc', 'Defaut', 'arborescence_zen', 'centre', '0', '', 'perso', 'breve')",
	"('', 'bloc', 'Defaut', 'arborescence_zen', 'centre', '0', '', 'perso', 'rubrique')",
	"('', 'bloc', 'Defaut', 'arborescence_zen', 'centre', '0', '', 'perso', 'auteur')",
    ), ),
