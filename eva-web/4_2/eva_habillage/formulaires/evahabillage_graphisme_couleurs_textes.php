...
function formulaires_evahabillage_graphisme_couleurs_textes_charger_dist(){
...
function formulaires_evahabillage_graphisme_couleurs_textes_traiter_dist(){
	...
	if (_request('eva_choix_texte')) {
		...
		$res['message_ok'] = 'Modification des couleurs des textes enregistr&eacute;e';
	}
	return $res;
}