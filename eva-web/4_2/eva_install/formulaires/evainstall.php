...
function formulaires_evainstall_traiter_dist(){
	...
	if (_request('creeract')) {
		$resultatgrp = sql_insertq(
			'spip_groupes_mots',
			array('titre'=>'activites','tables_liees'=>'articles,breves,rubriques,syndic,','descriptif'=>$descriptif,'unseul'=>'non','obligatoire'=>'non','minirezo'=>'oui','comite'=>'oui','forum'=>'non'));
		$res['message_ok'] = 'Le groupe <b>activites</b> vient d\'&ecirc;tre cr&eacute;&eacute;';
	}
	if (_request('creeraff')) {
		$resultatgrp = sql_insertq(
			'spip_groupes_mots',
			array('titre'=>'affichage','tables_liees'=>'articles,breves,rubriques,syndic,','descriptif'=>$descriptif,'unseul'=>'non','obligatoire'=>'non','minirezo'=>'oui','comite'=>'oui','forum'=>'non'));
