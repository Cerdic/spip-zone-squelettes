...
function eva_bonus_tab() {
	$retour=array(
		...
		array('inscription_newsletter','sommaire rubrique article breve site auteur','Propose un formulaire d\'inscription et d&eacute;sinscription &agrave; la newsletter du site. N&eacute;cessite les plugins Facteur, MailShot, MailSubscribers, Newsletters.','Olivier Gautier'),
