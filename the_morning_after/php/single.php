<?php get_header(); ?>
        ...
        <?php while (have_posts()) : the_post(); ?>
        	...
        	<div class="column span-11 first">
				...
				<div class="post_meta">
            		<img src="<?php bloginfo('stylesheet_directory'); ?>/images/bg/tag_green.png" class="posttag" alt="Print This Post" title="Print This Post" style="border: 0px;" /><?php the_tags('Tags: ', ', ', ''); ?>
            	</div>
