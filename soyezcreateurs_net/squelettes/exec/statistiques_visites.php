...
if (flag_svg()) {
	...
	$moyenne =  round($total_absolu / ((date("U")-$date_premier)/(3600*24)));
		...
		echo "</font></td>";
		echo "<td valign='top' width='33%'><font face='Verdana,Arial,Sans,sans-serif'>";
		echo '<a href="' . generer_url_ecrire("statistiques_referers","").'">'._T('info_aujourdhui').'</a> '.$visites_today;
		if ($val_prec > 0) echo '<br><a href="' . generer_url_ecrire("statistiques_referers","jour=veille").'">'._T('info_hier').'</a> '.$val_prec;
