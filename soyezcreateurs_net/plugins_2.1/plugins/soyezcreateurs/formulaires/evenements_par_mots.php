...
function formulaires_evenements_par_mots_charger_dist($filtre_groupes = null, $url_resultat = null){
	return 
		array(
			...
			'the_groupe'=>_request('the_groupe'),
			'mots'=>_request('mots')
		);
}

function formulaires_evenements_par_mots_verifier_dist($filtre_groupes = null, $url_resultat = null){
	$erreurs = array();
	if (_request('the_groupe') && _request('choixmot'))
...
function formulaires_evenements_par_mots_traiter_dist($filtre_groupes = null, $url_resultat = null){
