...
Le [Référentiel général d’accessibilité pour les administrations->http://references.modernisation.gouv.fr/rgaa-accessibilite] (RGAA) est le guide de référence (compatible avec les recommandations du W3C) pour assurer la mise en conformité des sites Internet publics.
...
EOF;
	...
	if ($article == 'Installation du site') {
		...
		$contenu['texte'] = "Cet événement est là pour vous montrer que vous pouvez utiliser un [agenda événementiel dans votre site->http://contrib.spip.net/Agenda-evenementiel-avec].";
	}
