...
$ajouter_mot, $ajouter_groupe, $afficher_texte, $url_param_retour)
{
	...
	if (!$retour_forum = rawurldecode(_request('retour_forum'))) {
		...
		if ($afficher_texte != 'non') 
			$previsu = inclure_previsu($texte, $titre, $url_site, $nom_site, $ajouter_mot, $id_article);
...
function inclure_previsu($texte,$titre, $url_site, $nom_site, $ajouter_mot, $id_article)
{
	$erreur = $bouton = '';
	if (strlen($texte) < 10
