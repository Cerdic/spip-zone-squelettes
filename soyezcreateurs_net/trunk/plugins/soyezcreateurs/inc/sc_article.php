...
EOF;
	...
	if ($article == "Politique d'accessibilité du site") {
		...
		$contenu['chapo'] = <<<EOF
Le [squelette SPIP SoyezCreateurs->http://www.spip-contrib.net/SoyezCreateurs,1237] utilisé sur ce site est conçu pour faciliter la mise en œuvre des bonnes pratiques de l'accessibilité des sites pour tous.
EOF;
		$contenu['texte'] = <<<EOF
...
[PYRAT.net|Expert SPIP->http://www.pyrat.net/] en utilisant l'outil [SPIP->http://www.spip.net/].
