...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'agenda_proposer_evenement' => 'اقترح مناسبة', # RELIRE
	'agenda_proposer_evenement_explication' => 'بإمكانك اقتراح مناسبة على المشرف على الموقع الذي سيختار نشرها من عدمه.  المناسيات التي تحتوي على أكثر تفاصيل لها فرص أكبر للموافقة عليها.', # RELIRE
	'agenda_proposer_evenement_title' => 'بإمكانك أن تقترح مناسبة على المشرف على الموقع', # RELIRE
	...
	'discus_en_cours' => 'محادثات جارية', # RELIRE
	...
	// L
	'layout_accueil_title' => 'تصميم مخصَّص للصفحة الرئيسية', # RELIRE
	'layout_defaut_title' => 'التصميم الافتراضي للموقع (المقالات و المواضيع)', # RELIRE
	'liresuitede' => 'اقرأ المزيد عن :',
	'liresuitesyndic' => 'اقرأ المزيد على الموقع الأصلي...',

	// M
	'memerubrique' => 'في نفس القسم...', # RELIRE
	'menu_picalt' => 'انقر لـ', # RELIRE
	'mot' => 'كلمة',
	'mots' => 'كلمات',
	'mots_title' => 'الكلمات المفاتيح للموقع',
	'motsgroupe' => 'مجموعة كلمات',
	'multimedia' => 'استمع',
	'multimedia_title' => 'استمع إلى أو شاهد المقتطف (يفتح نافذة جديدة)', # RELIRE
	...
	'sedna' => '(RSSبرنامج قراءة ال) Sedna ', # RELIRE
	'sommaire' => 'فهرس',
	'soyezcreateurs' => 'SoyezCréateurs', # RELIRE
	...
	'vous_souhaitez_etre_tenu_au_courant' => 'هل تريد أن تبقى مواكبا لما هو جديد ؟', # RELIRE
	...
	'wdcalendar_event' => 'مناسبة', # RELIRE
