...
if (!defined('_CHAMPS_INDENTITE_EXTRA_SC'))
	define('_CHAMPS_INDENTITE_EXTRA_SC', 'adresse,code_postal,ville,pays,telephone,fax,email_contact,informations,id_article_contact,id_image_pied,latitude,longitude,id_gis');
