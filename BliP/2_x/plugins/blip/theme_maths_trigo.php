...
$css_blip["#page|background"] = '#ffffff url(plugins/blip/theme_maths_trigo_logo.gif) top right no-repeat';
...
$css_blip[".barre_laterale|background"] = 'url(plugins/blip/theme_maths_trigo_logo2.gif) bottom right no-repeat';
$css_blip[".barre_laterale|padding"] = $css_blip_couleur['taille|espacement_bloc'].' 0 250px 0';
