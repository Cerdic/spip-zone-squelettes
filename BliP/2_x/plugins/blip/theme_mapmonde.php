...
$css_blip["#page|background"] = '#ffffff url(plugins/blip/theme_mapmonde_logo.jpg) top right no-repeat';
$css_blip['#tete|height'] = '100px';
$css_blip['#tete|width'] = '500px';
...
$css_blip[".barre_laterale|padding"] = '60px 0 0 0';
