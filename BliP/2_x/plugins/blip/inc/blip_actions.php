<?php
	...
	function BliP_installer_base() {
		...
		spip_query($req);
		$req = "INSERT INTO `spip_blip` VALUES (18, 'barre_laterale', 0, 5, 'statique', 'Barre lat̩rale', '/ceci est une zone personnalisable/', 'Vous pouvez y afficher du texte et/ou y inclure des modules.', '', 'oui');";
		spip_query($req);		
