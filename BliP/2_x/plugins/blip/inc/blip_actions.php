...
// ci-dessous, ça ne marche pas ...	
	...
	function BliP_installer_configuration() {
		...
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'menu_principal', 0, 20, 'lienpage', '<multi>[fr]Rubriques [en]Sections [it]Rubriche [ca]Secci&oacute;</multi>', '<multi>[fr]Parcourir les rubriques du site[en]To traverse the section of the site[it]Per attraversare le rubriche del sito[ca]Fullejar les seccions del web</multi>', 'rubrique', '', 'non');";
		spip_query($req);		
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'menu_principal', 0, 20, 'lienpage', '<multi>[fr]Rubriques [en]Sections [it]Rubriche [ca]Secci&oacute;</multi>', '<multi>[fr]Parcourir les rubriques du site[en]To traverse the section of the site[it]Per attraversare le rubriche del sito[ca]Fullejar les seccions del web</multi>', 'rubrique', '', 'non');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'menu_principal', 0, 30, 'lienpage', '<multi>[fr]Articles [en]Articles [it]Articoli [ca]Articles</multi>', '<multi>[fr]Liste des articles du site[en]List articles of the site[it]Lista degli articoli del sito[ca]Llistat d''articles del web</multi>', 'article', '', 'non');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'menu_principal', 0, 10, 'lienpage', '<multi>[fr]Actualit&eacute; [en]News [it]Notizie [ca]Actualitat</multi>', '<multi>[fr]Suivre l''actualit&eacute; de ce site[en]News of this site[it]Seguire le novita &agrave; del sito[ca]Seguir l''actualitat del lloc</multi>', 'sommaire', '', 'non');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'menu_principal', 0, 50, 'lienpage', '<multi>[fr]Auteurs [en]Authors [it]Autore [ca]Autors</multi>', '<multi>[fr]Liste des auteurs du site[en]List authors of the site[it]Elenco degli autori del sito[ca]Llistat d''autors del lloc</multi>', 'auteur', '', 'non');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'menu_principal', 0, 40, 'lienpage', '<multi>[fr]Mots-cl&eacute;s [en]Tags [it]Parole chiave [ca]Paraules clau</multi>', '<multi>[fr]Liste des mots-cl&eacute;s du site[en]Tags of the site[it]Parole chiave del sito[ca]Llistat de paraules clau del lloc web</multi>', 'mot', '', 'non');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale', 0, 20, 'dynamique', '-', '-', 'mod_liste_des_rubriques_v2.2', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale-sommaire', 0, 60, 'dynamique', '', '', 'mod_liste_des_articles_populaires_v2.2', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale-sommaire', 0, 50, 'dynamique', '-', '-', 'mod_liste_des_derniers_commentaires_v2.2', '-', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale-sommaire', 0, 70, 'dynamique', '', '', 'mod_liste_des_articles_maj_v2.2', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale-article', 0, 10, 'dynamique', '', '', 'mod_a_propos_de_cet_article_v2.2', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale-article', 0, 5, 'dynamique', '', '', 'mod_article_dans_la_meme_rubrique_v2.2', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale', 0, 90, 'dynamique', '', '', 'mod_rechercher_sur_le_site_v2.2', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale-recherche', 0, 95, 'dynamique', '', '', 'mod_recherche_externe_v2.2', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale', 0, 2, 'statique', 'Bonjour,', '', 'Votre site utilise le squelette modulaire <a href=\"http://www.cent20.net/spip.php?article100\">BliP</a>, et il semblerait que l\'installation se soit bien d&eacute;roul&eacute;e ;-)\r\n\r\n V.R.', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'mentions_techniques', 0, 50, 'lienpage', '', 'Oseriez-vous changer de couleurs ?', 'switch', '', 'non');";
		spip_query($req);	
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale-sommaire', 0, 1, 'dynamique', '-', '-', 'mod_selecteur_de_langue_v2.2', '', 'non');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale', 0, 10, 'dynamique', '-', '-', 'mod_rubriques_et_navigation_laterale_v2.3', '', 'oui');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale', 0, 95, 'dynamique', '-', '-', 'mod_identification_des_visiteurs_v2.2', '', 'non');";
		spip_query($req);
		$req = "INSERT INTO spip_blip (id_config, position, id_item, ordre, type, titre, descriptif, texte, style, actif) VALUES ('', 'barre_laterale', 0, 1, 'dynamique', '-', '-', 'mod_identification_se_deconnecter_v2.2', '', 'non');";
		spip_query($req);
	}
...
// ci-dessus, ça ne marche pas ...		
	...
	function BliP_tableau_config ($res) {
		...
		while ($elements = spip_fetch_array($res, SPIP_ASSOC)) {
			...
			echo "</td>";
			echo "<td style='text-align:center;'>".($restriction[1]?_T('blipconfig:blip_'.$restriction[1]):_T('blipconfig:blip_aucune'))."</td>";
			switch ($elements['type']) {
				case 'statique' :
					echo "<td><b>".$elements['titre']."</b><br /><i>".$elements['descriptif']."</i><br />".$elements['texte']."</td>";
					break;
				case 'dynamique' :
					echo "<td>".BliP_nom_module_lisible($elements['texte'].".html")."</td>";
					break;
				case 'lienpage' :
					echo "<td><b>".$elements['titre']."</b><br /><i>".$elements['descriptif']."</i><br />-&gt; ".BliP_nom_module_lisible($elements['texte'].".html").($elements['id_item']?" ".$elements['id_item']:"")."</td>";
					break;
			}
			echo "</tr>\n";
			$index++;
