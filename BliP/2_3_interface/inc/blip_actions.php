<?php
    ...
    function BliP_installer_configuration() {
        ...
        $req = "INSERT INTO `spip_blip` VALUES ('', 'menu_principal', 0, 20, 'lienpage', '<multi>[fr]Rubriques[en]Sections[it]Rubriche</multi>', '<multi>[fr]Parcourir les rubriques du site[en]To traverse the section of the site[it]Per attraversare le rubriche del sito</multi>', 'rubrique', '', 'oui');";
        spip_query($req);
        $req = "INSERT INTO `spip_blip` VALUES ('', 'menu_principal', 0, 30, 'lienpage', '<multi>[fr]Articles[en]Articles[it]Articoli</multi>', '<multi>[fr]Liste des articles du site[en]List articles of the site[it]Lista degli articoli del sito</multi>', 'article', '', 'oui');";
        spip_query($req);
        $req = "INSERT INTO `spip_blip` VALUES ('', 'menu_principal', 0, 10, 'lienpage', '<multi>[fr]Actualit&eacute;[en]News[it]Notizie</multi>', '<multi>[fr]Suivre l''actualit&eacute; de ce site[en]News of this site[it]Seguire le novita &agrave; del sito</multi>', 'sommaire', '', 'oui');";
        spip_query($req);
        $req = "INSERT INTO `spip_blip` VALUES ('', 'menu_principal', 0, 50, 'lienpage', '<multi>[fr]Auteurs[en]Authors[it]Autore</multi>', '<multi>[fr]Liste des auteurs du site[en]List authors of the site[it]Elenco degli autori del sito </multi>', 'auteur', '', 'oui');";
        spip_query($req);
        $req = "INSERT INTO `spip_blip` VALUES ('', 'menu_principal', 0, 40, 'lienpage', '<multi>[fr]Mots-cl&eacute;s[en]Tags[it]Parole chiave</multi>', '<multi>[fr]Liste des mots-cl&eacute;s du site[en]Tags of the site[it]Parole chiave del sito </multi>', 'mot', '', 'non');";
        spip_query($req);
