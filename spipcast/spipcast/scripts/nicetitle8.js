...
* Modified by Kevin Hale for unfoldedorigami.com use. Nicetitles now works with images and follows the mouse.
*
* Copyright (c) 2003 - 2004 Stuart Langridge, Paul McLanahan, Peter Janes, Brad Choate, Dunstan Orchard, Ethan Marcotte, Mark Wubben, Kevin Hale
* 
*
...
function NiceTitles(sTemplate, nDelay, nStringMaxLength, nMarginX, nMarginY, sContainerID, sClassName){
	...
	if(!nStringMaxLength){ nStringMaxLength = 55; }
...
NiceTitles.autoCreation = function(){
	...
	NiceTitles.autoCreated.images = new NiceTitles("<p class=\"titletext\">attr(nicetitle)</p><p class=\"destination\">attr(src)</p>", 600);
	//for form nicetitles. just add title to input and textarea tags
	NiceTitles.autoCreated.input = new NiceTitles("<p class=\"titletext\">attr(nicetitle)</p><p class=\"destination\">? <span class=\"accesskey\">Accesskey : [attr(accesskey)]</span>?</p>", 600);
	...
	NiceTitles.autoCreated.input.addElements(document.getElementsByTagName("input"), "id"); //added
	NiceTitles.autoCreated.input.addElements(document.getElementsByTagName("textarea"), "id"); //added
}
