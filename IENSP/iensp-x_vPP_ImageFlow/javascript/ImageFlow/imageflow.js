		...
		for(var index = 0; index < max; index++)
		{
			...
			if (node && node.nodeType == 1 && node.nodeName == 'IMG')
			{
				...
				if(thisObject.reflections === true)
				{
					...
					src =  'squelettes-test/iensp-x_vPP_ImageFlow/javascript/ImageFlow/reflect'+version+'.php?img=../../../../'+src+thisObject.reflectionGET+'&bgc=FFFFFF';
...
domReady(function()
{
	...
	Highslide.init({ ImageFlowID:'Highslide', onClick: function() { return hs.expand(this, {src: this.getAttribute('longdesc'), outlineType: 'rounded-white', showCredits: false, fadeInOut:true, dimmingOpacity: 0.75, captionText: this.getAttribute('alt')}); } });
